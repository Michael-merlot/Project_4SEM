...
public class DialogueUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialoguePanel.SetActive(false); // Диалоговое окно изначально скрыто
    }
    ...
    public void StartDialogue(DialogueScriptableObject dialogue)
    {
        ...
        dialoguePanel.SetActive(true); // Показываем диалоговое окно
    ...
    void EndDialogue()
    {
        ...
        dialoguePanel.SetActive(false); // Скрываем диалоговое окно
    }
}
